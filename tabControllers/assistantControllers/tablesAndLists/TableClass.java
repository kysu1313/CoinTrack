...
//        colorChangeCol();
     ...
     *
     * NOT WORKING. (trying to parse double to string??)
     */
    private void colorChangeCol() {
        this.cols.forEach((item) -> {
    ...
    @Override
    public void setCurrency(long currRate) {
                        ...
                        return new TableCell<SingleCoin, String>() {
                            ...
                            public void updateItem(String item, boolean empty) {
                                ...
                                if (!isEmpty()) {
                                    ...
                                    String newPrice = String.format("%.5f", Float.parseFloat(item) * Float.parseFloat("" + currRate));
                                    setText(newPrice);
                                }
                            }
                        };
    ...
    @Override
    public void setColor(String _colorUp, String _colorDown) {
        this.cols.forEach((item) -> {
            if (item.getText().equalsIgnoreCase("change")) {
                item.setCellFactory(new Callback<TableColumn, TableCell>() {
                    public TableCell call(TableColumn param) {
